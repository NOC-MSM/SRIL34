...
!  grid information 
!------------------------------------------------------------------------------
   sn_src_hgr = './coordinates.nc'   !  parent /grid/   
...
!  I/O 
!------------------------------------------------------------------------------
   sn_src_dir      = './CMEMS_2014.ncml' ! src_files/'
   sn_dst_dir      = './OUTPUT'

   sn_fn      = 'SRIL34_FES14'             ! prefix for output files
...
!------------------------------------------------------------------------------
	...
	sn_tide_fes      = '/projectsa/NEMO/Forcing/FES2014/'    ! SYMBOLIC LINK
