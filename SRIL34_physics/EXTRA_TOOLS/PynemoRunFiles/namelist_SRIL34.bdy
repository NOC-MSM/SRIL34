...
!  grid information 
!------------------------------------------------------------------------------
   sn_src_hgr = './CMEMS_subdomain_coordinates.nc'  !'./coordinates.nc'   !  parent /grid/   
   sn_src_zgr = './inputs_src_zgr.ncml'   !  parent
   sn_dst_hgr = './domain_cfg.nc'    !'./domain_cfg.nc'  ! child
   sn_dst_zgr = './inputs_dst.ncml' ! rename output variables
   sn_src_msk = './CMEMS_subdomain_mask.nc' ! NOT NEEDED FOR TIDES  ! parent   
   sn_bathy   = './bathy_meter.nc'  !       './bathy_meter.nc'        ! child


!------------------------------------------------------------------------------
!  I/O 
!------------------------------------------------------------------------------
   sn_src_dir      = '/work/n01/n01/$USER/$PathToNCML/CMEMS_2014.ncml' ! src_files/'
   sn_dst_dir      = './OUTPUT'
   sn_ncml_out     = './output_NCML'

   sn_fn      = 'TestSril'             ! prefix for output files
...
!------------------------------------------------------------------------------
    ...
    cn_mask_file   = './mesh_mask.nc'            !  name of mask file
...
!  Time information
!------------------------------------------------------------------------------
    nn_year_000     = 2014        !  year start
    nn_year_end     = 2014        !  year end
